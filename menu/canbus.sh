...
mapfile -t scripts < <(jq -r '.[].script' canbus.json)
mapfile -t descriptions < <(jq -r '.[].description' canbus.json)
mapfile -t descriptionReinstalls < <(jq -r '.[].descriptionReinstall' canbus.json)
mapfile -t fileChecks < <(jq -r '.[].fileCheck' canbus.json)
